...
/**
 * Manage execution of MVVM Page
 * {@inheritDoc}
 */
class MVVM extends Controller {

    public function execute() {
        
        // Variable texts
        $inset['title'] = "Model View View-Model";
        $inset['desc'] = "Page descriptive du patron d'architecture Modèle-Vue-VueModèle";
        $inset['route'] = $this->request()->path()[1];
        $data = Data::retrieveOne($inset['route']);
        
        // View rendering
        $content = new Render([__DIR__, '..', 'View', 'ModelViewViewModel.php'], ['data' => $data]);
