...
<div id="previous" class="bypass">
    <a href="./model-view-controller" title="Aller à la page" class="holder">
        <span class="cursor">&nbsp;</span>
        <span class="label">Model-View-Controller</span>
    </a>
</div>
<div id="next" class="bypass">
    <a href="./model-view-presentation" title="Aller à la page" class="holder">
        <span class="cursor">&nbsp;</span>
        <span class="label">Model-View-Presentation</span>
    </a>
</div>